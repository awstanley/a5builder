...
export ALLEGRO_SOURCES="http://download.gna.org/allegro/allegro/5.2.0/allegro-5.2.0.tar.gz"
export ALLEGRO_ARCHIVE="allegro-5.2.0.tgz"
export ALLEGRO_INNER="allegro-5.2.0.0"
